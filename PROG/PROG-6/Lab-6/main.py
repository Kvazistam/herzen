...
if __name__ == '__main__':
    time_res_cy = timeit.repeat("res = [fermat_factorization(i) for i in TEST_LST];",
                  setup='import math; from ferma_cy import is_perfect_square; from ferma_cy import fermat_factorization; TEST_LST = [3000009, 700000133, 61335395416403926747]',
                  number=10, repeat=1)
    time_res_py = timeit.repeat("res = [fermat_factorization(i) for i in TEST_LST];",
                  setup='import math; from ferma import is_perfect_square; from ferma import fermat_factorization; TEST_LST = [3000009, 700000133, 61335395416403926747]',
                  number=10, repeat=1)
    print(f"Результаты программы:\n\t Cython - {time_res_cy}\n\t Python - {time_res_py}")
