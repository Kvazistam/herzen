...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.fire_sound = pygame.mixer.Sound(resources.fire_sound)
        self.click_sound = pygame.mixer.Sound(resources.click_sound)
        self.kill_sound = pygame.mixer.Sound(resources.kill_sound)
        self.death_sound = pygame.mixer.Sound(resources.death_sound)
        self.final_sound = pygame.mixer.Sound(resources.final_sound)
        pygame.mixer.music.load(resources.music_path)
